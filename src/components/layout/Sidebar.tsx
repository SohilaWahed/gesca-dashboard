  ...
  return (
    <aside className={` ${isOpen ? 'block' : "hidden"} md:block bg-surface  border-r border-border w-20 lg:w-64 px-4 py-6 lg:px-6 flex flex-col justify-between fixed top-16 bottom-0 md:top-0 z-50 `}>
      <div className='flex-1 flex flex-col'>
        <h1 className="logo capitalize text-primary hidden md:flex items-center justify-center lg:justify-start gap-2 mb-8"> <Siren size={28} /><span className='hidden lg:block text-lg lg:text-xl font-bold tracking-wide'>GESCA</span></h1>
        <TooltipProvider>
